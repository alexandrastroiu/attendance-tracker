...
const ManageCourses = () => {
  ...
  const fetchCourses = async () => {
    const res = await fetch(`${BASE_URL}/getCourses.php`, {
      credentials: "include",
    });
        ...
        <div className="users-section">
          ...
          {expandAdd && (
            <div className="users-form">
              ...
              <button className="users-submit" onClick={handleAddCourse}>
                Submit
              </button>
            </div>
          )}
            ...
            <div className="users-form">
              <select
                ...
                onChange={(e) => {
                  const selected = courses.find(
                    (c) => c.course_id === parseInt(e.target.value)
                  );
                  setCourseForm({
              ...
              {courseForm.course_id && (
                <>
                  ...
                  <button className="users-submit" onClick={handleEditCourse}>
                    Submit
                  </button>
                </>
              )}
