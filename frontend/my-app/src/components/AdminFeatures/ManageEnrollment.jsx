...
const BASE_URL =
  "http://localhost:8888/management_attendance/attendance-tracker/backend/api/admin/enrollment";
...
const ManageEnrollments = () => {
  ...
  const fetchEnrollments = async () => {
    const res = await fetch(`${BASE_URL}/getEnrollments.php`, {
      credentials: "include",
    });
        ...
        <div className="users-section">
          ...
          {expandAdd && (
            <div className="users-form">
              ...
              <button className="users-submit" onClick={handleAdd}>
                Submit
              </button>
            </div>
          )}
            ...
            <div className="users-table-wrapper">
              ...
              {form.old_student_id && form.old_course_id && (
                <div className="users-form" style={{ marginTop: "20px" }}>
                  ...
                  <button className="users-submit" onClick={handleEdit}>
                    Submit
                  </button>
                </div>
              )}
              ...
              {enrollments.map((e) => (
                <li key={`${e.student_id}-${e.course_id}`}>
                  ...
                  <button
                    ...
                    onClick={() => handleDelete(e.student_id, e.course_id)}
                  >
                    Delete
                  </button>
                </li>
